        ...
        <Col  lg={6} className="d-flex flex-column align-items-center">
          <Form style={{width: '100%'}} className="d-flex flex-column align-items-center">
              ...
              <Form.Group>
                ...
                <Form.Control type="text" placeholder="Bengkel Name" className="mb-1 mr-sm-1 rounded-pill" style={{ width: '100%' }} />
              </Form.Group>

              <Form.Group>
                <Form.Label><p style={{ color: '#636363', paddingLeft: 10, fontSize: 14, marginBottom:'-10%' }}>Address</p></Form.Label>
                <Form.Control type="text" placeholder="Address" className="mb-1 mr-sm-1 rounded-pill" style={{ width: '100%' }} />
              </Form.Group>

              <Form.Group>
                <Form.Label><p style={{ color: '#636363', paddingLeft: 10, fontSize: 14, marginBottom:'-10%' }}>Email</p></Form.Label>
                <Form.Control type="text" placeholder="Email" className="mb-1 mr-sm-1 rounded-pill" style={{ width: '100%' }} />
              </Form.Group>

              <Form.Group>
                <Form.Label><p style={{ color: '#636363', paddingLeft: 10, fontSize: 14, marginBottom:'-10%' }}>Username</p></Form.Label>
                <Form.Control type="text" placeholder="Username" className="mb-1 mr-sm-1 rounded-pill" style={{ width: '100%' }} />
              </Form.Group>

              <Form.Group>
                <Form.Label><p style={{ color: '#636363', paddingLeft: 10, fontSize: 14, marginBottom:'-10%' }}>Password</p></Form.Label>
                <Form.Control type="password" placeholder="Password" className="mb-1 mr-sm-1 rounded-pill" style={{ width: '100%' }} />
              </Form.Group>
